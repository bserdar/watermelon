...
func (*Request) Descriptor() ([]byte, []int) {
	return fileDescriptor_ae7704718fb7daeb, []int{10}
}
...
func (*Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_ae7704718fb7daeb, []int{11}
}
...
var fileDescriptor_ae7704718fb7daeb = []byte{
	...
	,
}
...
type LifecycleClient interface {
	...
	GetArgs(ctx context.Context, in *Session, opts ...grpc.CallOption) (*Args, error)
...
func (c *lifecycleClient) GetArgs(ctx context.Context, in *Session, opts ...grpc.CallOption) (*Args, error) {
	out := new(Args)
	err := c.cc.Invoke(ctx, "/pb.Lifecycle/GetArgs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LifecycleServer interface {
	...
	// Get arguments to the program
	GetArgs(context.Context, *Session) (*Args, error)
	// Loads a module by its name, and returns the GRPC location for the module
	// Use this to setup a direct GRPC link to the module
...
func _Lifecycle_GetArgs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Session)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LifecycleServer).GetArgs(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.Lifecycle/GetArgs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LifecycleServer).GetArgs(ctx, req.(*Session))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Lifecycle_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetArgs",
			Handler:    _Lifecycle_GetArgs_Handler,
		},
		{
